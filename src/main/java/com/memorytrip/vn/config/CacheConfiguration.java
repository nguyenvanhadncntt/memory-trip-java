package com.memorytrip.vn.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.memorytrip.vn.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.memorytrip.vn.repository.UserRepository.USERS_BY_EMAIL_CACHE);
